...
if __name__ == '__main__':
    ...
    censored = pd.read_csv(base_path + "locate_censored_level_6.csv", index_col=0)
    uncensored = pd.read_csv(base_path + "locate_uncensored_level_6.csv", index_col=0)
    ...
    output_dir = "/home/pintokf/Projects/Microbium/Mouses/Ratio_model_after_locate/Winner_model"
