...
if __name__ == '__main__':
    ...
    # --- 2. Load Data ---
    censored = pd.read_csv("/home/pintokf/Projects/Microbium/Mouses/Ratio_model_metabolites/preprocces_ratio_metabolites/metabolites_censored.csv", index_col=0)
    uncensored = pd.read_csv("/home/pintokf/Projects/Microbium/Mouses/Ratio_model_metabolites/preprocces_ratio_metabolites/metabolites_uncensored.csv", index_col=0)
    ...
    for i, (train_idx, test_idx) in enumerate(logo.split(uncensored, groups=uncensored["Cage"])):
        ...
        lbl = LBL("diff", "MiceName", "AgeMonths", num_of_bact=1889, feature_selection=25, with_microbiome=True,
    ...
    output_dir = "/home/pintokf/Projects/Microbium/Mouses/Ratio_model_metabolites/Winner_model"
    # תוספת: שמירת הגרף לתיקייה שביקשת
    plot_path = os.path.join(output_dir, "prediction_vs_actual_plot.png")
