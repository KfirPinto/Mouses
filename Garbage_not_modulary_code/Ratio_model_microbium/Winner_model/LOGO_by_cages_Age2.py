...
if __name__ == '__main__':
    ...
    for i, (train_idx, test_idx) in enumerate(logo.split(uncensored, groups=uncensored["Cage"])):
        ...
        lbl = LBL("diff", "MiceName", "AgeMonths", num_of_bact=35, feature_selection=15, with_microbiome=True,
    ...
    output_dir = "/home/pintokf/Projects/Microbium/Mouses/Ratio_model_microbium/Winner_model"
