...
z_train_path = f"{base_path}/Locate_model/Whole_data/inference/locate_Z_train_level_6.csv"
z_test_path = f"{base_path}/Locate_model/Whole_data/inference/locate_Z_test_level_6.csv"
metabo_path = f"{base_path}/preprocess_metabolits/preprocessed_metabolites_normalized_z_score.csv"
output_dir = f"{base_path}/Locate_model/Evaluation/Whole_data/inference"
