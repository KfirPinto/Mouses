...
if __name__ == '__main__':
    ...
    for i, (train_idx, test_idx) in enumerate(logo.split(uncensored, groups=uncensored["Cage"])):
        ...
        lbl = LBL("diff", "MiceName", "AgeMonths", num_of_bact=1889, feature_selection=1889, with_microbiome=True,
    ...
    plt.savefig("LOOCV_age2_results_7.png")
    print("\nPlot saved as 'LOOCV_age2_results.png'")