...
if __name__ == '__main__':
    ...
    log_file_path = os.path.join(output_dir, "feature_selection_all_age_results_LOGO.txt")
    sys.stdout = Logger(log_file_path)

    print(f"--- Starting Feature Selection Sweep (Detailed Output - LOGO) ---")
    ...
    # Filtering Age 2 (Commented out as per your previous code)
    ...
    for k in k_values_to_test:
        ...
        if len(all_predictions_list) > 0:
            ...
            summary_results.append({
                ...
                "Pearson_Corr": pear_corr,     # Added
                "P_Value_Spearman": spr_p      # Added/Renamed
            })
        else:
