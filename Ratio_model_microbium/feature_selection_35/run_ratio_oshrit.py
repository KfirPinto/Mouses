...
if __name__ == '__main__':
    ...
    censored = pd.read_csv("/home/pintokf/Projects/Microbium/Mouses/Ratio_model_microbium/Preprocces_for_ratio_model/data_level7_censored.csv", index_col=0)
    censored["Cage"] = [i.split("-")[0] for i in censored.index]
    censored = censored[censored["AgeMonths"] == 2]
    uncensored = pd.read_csv("/home/pintokf/Projects/Microbium/Mouses/Ratio_model_microbium/Preprocces_for_ratio_model/data_level7_uncensored.csv", index_col=0)
