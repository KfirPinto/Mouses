...
if __name__ == '__main__':
    # --- 4. Setup Logging ---
    output_dir = "/home/pintokf/Projects/Microbium/Mouses/Ratio_model_microbium/hyper_feature_selection_level_7"
    
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
        
    log_file_path = os.path.join(output_dir, "feature_selection_age2_results.txt")
    ...
    # Filtering Age 2 (Efficiently done before splitting cages)
    ...
    print(f"Total Censored samples (Age 2): {len(censored)}")
    print(f"Total Uncensored samples (Age 2): {len(uncensored)}")
