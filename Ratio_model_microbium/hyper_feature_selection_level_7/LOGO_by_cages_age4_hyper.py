...
if __name__ == '__main__':
    ...
    log_file_path = os.path.join(output_dir, "feature_selection_age4_results.txt")
    ...
    print(f"Total Censored samples (Age 4): {len(censored)}")
    print(f"Total Uncensored samples (Age 4): {len(uncensored)}")
